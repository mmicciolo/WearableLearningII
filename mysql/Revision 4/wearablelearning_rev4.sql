...
CREATE TABLE IF NOT EXISTS `wearablelearning`.`gameState` (
  ...
  `buttonInputType` VARCHAR(45) NULL,
  `rfid` VARCHAR(45) NULL,
  `gameStateCount` INT NULL,
...
-- -----------------------------------------------------
-- Table `wearablelearning`.`players`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wearablelearning`.`players` (
  `playerId` INT NOT NULL AUTO_INCREMENT,
  `gameInstanceId` INT NULL,
  `studentId` INT NULL,
  `currentGameState` INT NULL,
